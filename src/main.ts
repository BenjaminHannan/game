/**
 * Civitopia entry point: constructs every subsystem, wires them together and
 * starts the engine.
 */
...
function boot(): void {
  ...
  if (!(canvas instanceof HTMLCanvasElement) || !uiRoot) {
    throw new Error('Civitopia: #game-canvas or #ui-root is missing from the page.');
  }
  ...
  console.log(
    '%cCivitopia%c — engine foundation online.\n' +
