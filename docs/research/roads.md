...
Research notes on the road-building systems of *Cities: Skylines II* (Colossal Order / Paradox Interactive, released October 24, 2023), compiled to support an original, faithful reimplementation of the mechanics in *Metropolis*. All numeric values below are **facts about game behavior** (parameters, not expression) and are documented here in the researcher's own words.
